...
public class Store {
	...
	public Store(String StoreID, String StoreName, String Address,
			...
			String AlternatePhone, String Price_Verification, String Price_VerDueDate,
			String FuelDispenser, String FuelDueDate, String Scale, String ScaleDueDate,
			String Timing, String TimingDueDate, String MiscInspection, String MiscDueDate,
			String Fee, String OOB, String Remarks, String NewAddress, String NewMunicipality){
