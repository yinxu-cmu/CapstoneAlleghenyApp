...
//		Log.d("MAP","get Stores by zip");
//		List <Store> storeList = sh.getStoreByZip(zip);
//		Log.d("MAP","storelist size "+storeList.size());
//		Store store;
//		Log.d("MAP","start zip");
//		if(storeList != null){
//			StringBuilder sb = new StringBuilder();
//			Iterator i = storeList.iterator();
//			Log.d("MAP","start while");
//			while(i.hasNext()){
//				Log.d("MAP","while iteration");
//				store = (Store)i.next();
//				Log.d("stores",store.getStoreID()+" "+store.getStoreName()+" "+store.getZip()+store.getAddress());
